...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend6.Models.File", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Backend6.Models.Folder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Backend6.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Backend6.Models.File", b =>
                {
                    b.HasOne("Backend6.Models.Folder", "Folder")
                        .WithMany("Files")
            ...
            modelBuilder.Entity("Backend6.Models.Folder", b =>
                {
                    ...
                    b.HasOne("Backend6.Models.Folder", null)
                        .WithMany("Folders")
                        .HasForeignKey("FolderId");
                });
